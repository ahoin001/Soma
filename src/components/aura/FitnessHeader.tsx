...
export const FitnessHeader = ({
  ...
  <header className="relative overflow-hidden rounded-[36px] bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 px-6 pb-10 pt-6 text-white shadow-[0_20px_45px_rgba(15,23,42,0.5)]">
    ...
    <div className="relative z-10 mt-6 grid grid-cols-2 gap-3 text-white/80">
    ...
    <Button className="relative z-10 mx-auto mt-5 rounded-full bg-emerald-400 px-6 text-slate-950 shadow-[0_12px_24px_rgba(45,212,191,0.35)] hover:bg-emerald-300">
      Start workout
