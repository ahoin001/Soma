    ...
    <div className="mt-6 rounded-xl border border-emerald-200 bg-emerald-50/60 p-4">
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2">
        <div>
          ...
          <Input
            ...
            className="mt-1 h-10 rounded-full bg-white"
          />
        </div>
        <div>
          <Label className="text-xs text-slate-600">Sex (for calorie estimate)</Label>
          <Select value={sex} onValueChange={(v) => setSex(v as Sex)}>
            <SelectTrigger className="mt-1 h-10 rounded-full bg-white">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
        ...
        <div>
          ...
          <div className="mt-1 flex items-center gap-2">
            <Input
              ...
              className="h-10 w-14 rounded-full bg-white text-center"
            />
        ...
        <div>
          <Label className="text-xs text-slate-600">Weight (lbs)</Label>
          <Input
            type="number"
            min={80}
            max={500}
        ...
        <div>
          <Label className="text-xs text-slate-600">Activity level</Label>
        ...
        <div>
          <Label className="text-xs text-slate-600">Lifting experience</Label>
          <Select
            value={experience}
      ...
      {recommendation && (
        <div className="mt-4 rounded-lg border border-emerald-200 bg-white px-4 py-3">
          <p className="text-sm font-semibold text-slate-800">Your targets</p>
          ...
          <p className="mt-3 text-sm font-semibold text-slate-800">How you should approach it</p>
...
export function RecompArticleBody() {
  return (
    <article className="max-w-none">
      ...
      <h2 className="mt-6 text-lg font-semibold text-slate-900">What is recomp, and who is it for?</h2>
      ...
      <h2 className="mt-6 text-lg font-semibold text-slate-900">Pros and cons of recomp</h2>
      <div className="mt-3 grid gap-3 sm:grid-cols-2">
        <div className="rounded-lg border border-emerald-200 bg-emerald-50/60 px-3 py-3">
          <p className="text-xs font-semibold uppercase tracking-wider text-emerald-700">Pros</p>
        ...
        <div className="rounded-lg border border-amber-200 bg-amber-50/60 px-3 py-3">
          <p className="text-xs font-semibold uppercase tracking-wider text-amber-700">Cons</p>
          <ul className="mt-2 list-disc space-y-1 pl-4 text-sm text-slate-700">
      ...
      <h2 className="mt-6 text-lg font-semibold text-slate-900">Best-practice way to do recomp</h2>

      <h3 className="mt-4 text-base font-semibold text-slate-800">1. Calories</h3>
      ...
      <h3 className="mt-4 text-base font-semibold text-slate-800">2. Protein</h3>
      <p className="mt-1 text-sm leading-relaxed text-slate-700">
      ...
      <h3 className="mt-4 text-base font-semibold text-slate-800">3. Training</h3>
      <p className="mt-1 text-sm leading-relaxed text-slate-700">
      ...
      <h3 className="mt-4 text-base font-semibold text-slate-800">4. Sleep and recovery</h3>
      <p className="mt-1 text-sm leading-relaxed text-slate-700">
      ...
      <h3 className="mt-4 text-base font-semibold text-slate-800">5. Timeline and expectations</h3>
      <p className="mt-1 text-sm leading-relaxed text-slate-700">
      ...
      <h2 className="mt-8 text-lg font-semibold text-slate-900">When to choose recomp vs. cut vs. bulk</h2>
      <ul className="my-3 list-disc space-y-2 pl-5 text-sm text-slate-700">
      ...
      <h2 className="mt-6 text-lg font-semibold text-slate-900">What to avoid</h2>
