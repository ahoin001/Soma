    ...
    <div className="mt-4 rounded-xl border border-emerald-100 bg-emerald-50/50 p-4">
      ...
      <div className="mt-3 flex flex-wrap items-center gap-2">
        <Input
          ...
          className="h-10 w-28 rounded-full bg-white text-sm"
        />
        <span className="text-sm text-slate-500">mg sodium/day</span>
      </div>
      {valid && band && (
        <div
          className={cn(
            "mt-3 rounded-lg border px-3 py-2 text-sm",
            band === "safe" && "border-emerald-200 bg-emerald-50 text-emerald-800",
            band === "moderate" && "border-amber-200 bg-amber-50 text-amber-800",
            band === "risky" && "border-orange-200 bg-orange-50 text-orange-800",
            band === "high" && "border-rose-200 bg-rose-50 text-rose-800",
          )}
        >
          <strong>
...
export function FaceRoundnessArticleBody() {
  return (
    <article className="max-w-none">
      ...
      <h2 className="mt-6 text-lg font-semibold text-slate-900">1. Body fat: the biggest lever for actual face shape</h2>
      ...
      <h2 className="mt-6 text-lg font-semibold text-slate-900">3. Junk food and inflammation</h2>
      <p className="mt-1 text-xs text-slate-600">
      ...
      <h2 className="mt-6 text-lg font-semibold text-slate-900">4. Walking and daily movement</h2>
      <p className="mt-1 text-xs text-slate-600">
      ...
      <h2 className="mt-6 text-lg font-semibold text-slate-900">5. Sleep and stress</h2>
      <p className="mt-1 text-xs text-slate-600">
      ...
      <h2 className="mt-6 text-lg font-semibold text-slate-900">6. Alcohol</h2>
      <p className="mt-1 text-xs text-slate-600">
      ...
      <h2 className="mt-6 text-lg font-semibold text-slate-900">Quick priority list</h2>
      <p className="mt-1 text-xs text-slate-600">
      ...
      <ol className="my-3 list-decimal space-y-2 pl-5 text-sm text-slate-700">
