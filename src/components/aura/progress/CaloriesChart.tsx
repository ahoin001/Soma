...
export const CaloriesChart = ({ entries }: { entries: TrendEntry[] }) => {
      ...
      <div className="relative min-w-0 flex-1">
        ...
        >
          <defs>
            ...
            <linearGradient id="calorieFill" x1="0%" y1="0%" x2="0%" y2="100%">
        ...
        {activePoint ? (
          <div
            className="pointer-events-none absolute -top-2 z-10 -translate-y-full rounded-[14px] bg-white px-3 py-2 text-xs text-sky-800 shadow-[0_12px_28px_rgba(14,165,233,0.18)]"
            style={{
          ...
          >
            <div className="text-[11px] font-semibold text-sky-700">
              {Math.round(activePoint.entry.value ?? 0)} cal
            </div>
            <div className="text-[10px] text-sky-600/70">
