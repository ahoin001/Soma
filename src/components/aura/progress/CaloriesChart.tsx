  ...
  return (
    <div className="relative flex">
      ...
      <div className="relative min-w-0 flex-1">
        ...
        {activePoint ? (
          <div
            className="pointer-events-none absolute -top-2 z-10 -translate-y-full rounded-[14px] bg-card px-3 py-2 text-xs text-foreground shadow-[0_12px_28px_rgba(14,165,233,0.18)]"
            style={{
