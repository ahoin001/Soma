...
export const DashboardHeader = ({
  ...
  const handleMacroCardsClick = useCallback(() => {
    // Ignore click right after a long-press action.
                ...
                <div className="flex items-start justify-between gap-1">
                  ...
                  {hasSources && (
                    <Popover>
                      ...
                      <PopoverContent
                        className="w-72 overflow-hidden rounded-2xl border border-primary/25 bg-gradient-to-br from-background/95 via-card/95 to-secondary/65 p-0 shadow-[0_20px_45px_rgba(14,165,233,0.18)] backdrop-blur-xl data-[state=open]:zoom-in-90 data-[state=closed]:zoom-out-95"
                        align="start"
                        side="bottom"
                        sideOffset={8}
                      >
                        <div className="border-b border-primary/15 bg-primary/5 px-3 py-2">
      ...
      <div className="relative z-20 mt-5 px-5 overflow-hidden">
        <AnimatePresence initial={false}>
          {showMicros && micros ? (
            <motion.div
              key="hud-micros"
              initial={{ opacity: 0, y: -12, scale: 0.985, height: 0 }}
              animate={{ opacity: 1, y: 0, scale: 1, height: "auto" }}
              exit={{ opacity: 0, y: -8, scale: 0.985, height: 0 }}
              transition={{
                height: { duration: 0.28, ease: "easeOut" },
                opacity: { duration: 0.18, ease: "easeOut" },
                y: { type: "spring", stiffness: 300, damping: 28, mass: 0.7 },
                scale: { duration: 0.2, ease: "easeOut" },
              }}
              className="overflow-hidden rounded-2xl border border-primary/20 bg-gradient-to-br from-card/65 via-card/55 to-secondary/40 pb-4 pt-3 shadow-[0_18px_36px_rgba(14,165,233,0.12)] backdrop-blur"
            >
